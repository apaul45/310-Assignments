...
def receiveOnePing(mySocket, ID, timeout, destAddr):
    ...
    while 1:
        ...
        header = struct.unpack_from("bbHHh", recPacket, offset=20)
        timeSent, = struct.unpack_from("d", recPacket, offset=28)

        if header[3] == ID: #Identify packets part of this process
